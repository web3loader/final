"use strict";(self.webpackChunk_uniswap_interface=self.webpackChunk_uniswap_interface||[]).push([[317],{56588:function(e,t,n){n.d(t,{Z:function(){return f}});var i=n(42893),o=n(12204),r=n(84071),s=n(34578),c=n(87253),a=n(65647);const d=c.default.div.withConfig({displayName:"RangeBadge__BadgeWrapper",componentId:"sc-5538a536-0"})`
  font-size: 14px;
  display: flex;
...
`;t.Z=({text:e,maxCharacters:t=20,margin:n=!1,adjustSize:c=!1,fontSize:a,textColor:d,link:l,...u})=>{const[p,f]=(0,r.useState)(!1);return e?e.length>t?(0,i.jsx)(o.ZP,{text:e,show:p,children:(0,i.jsx)(s,{onMouseEnter:()=>f(!0),onMouseLeave:()=>f(!1),margin:n,adjustSize:c,textColor:d,link:l,fontSize:a,...u,children:" "+e.slice(0,t-1)+"..."})}):(0,i.jsx)(s,{margin:n,adjustSize:c,link:l,fontSize:a,textColor:d,...u,children:e}):(0,i.jsx)("span",{})}},22230:function(e,t,n){n.d(t,{N:function(){return A},Z:function(){return M}});var i=n(42893),o=n(12204),r=n(15387),s=n(35206),c=n(56588),a=n(45533),d=n(94160),l=n(25575),u=n(2304),p=n(15627),f=n(58127),m=n(46109),h=n(13712),x=n(41440),g=n(4292),w=n(87253),I=n(1990),_=n(39839),b=n(57482),y=n(49111),k=n(58025);const j=(0,w.default)(x.rU).withConfig({displayName:"PositionListItem__LinkRow",componentId:"sc-c6f6cae0-0"})`
  align-items: center;
  display: flex;
  cursor: pointer;
  user-select: none;
...
//# sourceMappingURL=317.227ffc05.chunk.js.map